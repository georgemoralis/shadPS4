...
struct OrbisHttpNBEvent {
    u32 events;      // +0x00
    u32 eventDetail; // +0x04
    s32 id;          // +0x08
    s32 pad;         // +0x0C
    void* userdata;  // +0x10
};
static_assert(sizeof(OrbisHttpNBEvent) == 24);

constexpr u32 ORBIS_HTTP_NB_EVENT_RECV = 0x00001;
constexpr u32 ORBIS_HTTP_NB_EVENT_SEND = 0x00002;
constexpr u32 ORBIS_HTTP_NB_EVENT_RESOLVED = 0x00004;
constexpr u32 ORBIS_HTTP_NB_EVENT_ERROR = 0x00008;
constexpr u32 ORBIS_HTTP_NB_EVENT_HUP = 0x00010;
constexpr u32 ORBIS_HTTP_NB_EVENT_TIMEOUT = 0x00020;
constexpr u32 ORBIS_HTTP_NB_EVENT_SOCK_OPEN = 0x20;
constexpr u32 ORBIS_HTTP_NB_EVENT_RESPONSE_COMPLETE = 0x20000;

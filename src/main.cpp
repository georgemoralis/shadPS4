...
int main(int argc, char* argv[]) {
    ...
    // const char* const ebootPath = "C:/ps4/games/CUSA32058/eboot.bin";//andro dunos 2
    //const char* const ebootPath = "C:/ps4/games/CUSA03173/eboot.bin";//bloodborne
    //const char* const ebootPath = "C:/ps4/games/CUSA06212/eboot.bin";//resident evil reveletions
    //const char* const ebootPath = "C:/ps4/games/CUSA16596/eboot.bin"; //Cyberpunk 2077 
    //const char* const ebootPath = "C:/ps4/games/CUSA00362/eboot.bin";//alien isolation
    const char* const ebootPath = "C:/ps4/sdk-samples/rain.elf";

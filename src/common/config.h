...
std::string GetNp2ServerHost();
std::string GetSignalingAddr();
u16 GetSignalingPort();
void setNp2ServerHost(std::string host, bool is_game_specific = false);
void setSignalingAddr(std::string addr, bool is_game_specific = false);
void setSignalingPort(u16 port, bool is_game_specific = false);
